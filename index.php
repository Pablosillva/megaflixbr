...
<body>
    ...
    <header>
        <div class="nav container">
            <a href="index.php" class="logo" title="MegaflixBR">
                Megaflix<span>BR</span>
            </a>
            <div class="busca-site">
                <input type="search" class="busca-input" placeholder="Buscar Filmes">
                <i class="bx bx-search"></i>
            </div>
            <a href="" class="user">
                <img src="assets/img//p1.png" alt="Maykon Silveira" class="user-img">
            </a>
            <div class="navbar">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="filme-box">
                        ...
                        <div class="box-titulo">
                            <h2 class="titulo-filme">Genesis: o ínicio de tudo!</h2>
                            <span class="categoria-filme">Gospel</span>
                ...
                <div class="swiper-slide">
                    <div class="filme-box">
                        ...
                        <div class="box-titulo">
                            <h2 class="titulo-filme">Gênesis: o ínicio de tudo!</h2>
                            <span class="categoria-filme">Gospel</span>
                            <a href="ver-filme.php" class="ver-btn play-btn">
                                <i class="bx bx-right-arrow"></i>
                            </a>
    ...
    <section class="filmes container" id="movies">
        <div class="topFilmes">
            <h2 class="topTitulo">Filmes e Shows</h2>
        </div>
    ...
    <footer class="direitos">
        <p>&#169; Todos os direitos reservados a Pablo Silva.</p>
    </footer>
    <!-- Fim Rodapé -->
